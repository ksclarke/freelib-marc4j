...
public class StaticTestRecords {
    ...
    public static final String RESOURCES_SUMMERLAND_MARC_IN_JSON_INDENTED_JSON =
            "/summerland-marc-in-json-indented.json";
    ...
    static {
        ...
        chabon[0].addVariableField(factory.newDataField("245", '1', '4', "a",
                "The amazing adventures of Kavalier and Clay :", "b", "a novel /", "c", "Michael Chabon."));
        chabon[0].addVariableField(factory.newDataField("260", ' ', ' ', "a", "New York :", "b", "Random House,", "c",
                "c2000."));
        chabon[0].addVariableField(factory.newDataField("300", ' ', ' ', "a", "639 p. ;", "c", "25 cm."));
        chabon[0].addVariableField(factory.newDataField("650", ' ', '0', "a", "Comic books, strips, etc.", "x",
                "Authorship", "v", "Fiction."));
        chabon[0].addVariableField(factory.newDataField("650", ' ', '0', "a", "Heroes in mass media", "v",
                "Fiction."));
        ...
        chabon[1].addVariableField(factory.newDataField("245", '1', '0', "a", "Summerland /", "c",
                "Michael Chabon."));
        chabon[1].addVariableField(factory.newDataField("250", ' ', ' ', "a", "1st ed."));
        chabon[1].addVariableField(factory.newDataField("260", ' ', ' ', "a", "New York :", "b",
                "Miramax Books/Hyperion Books for Children,", "c", "c2002."));
        chabon[1].addVariableField(factory.newDataField("300", ' ', ' ', "a", "500 p. ;", "c", "22 cm."));
        chabon[1].addVariableField(factory.newDataField("520", ' ', ' ', "a",
    ...
    private static Record makeSummerlandRecord() {
        final Record sumland = factory.newRecord("00714cam a2200205 a 4500");
        ...
        sumland.addVariableField(factory.newDataField("260", ' ', ' ', "a", "New York :", "b",
                "Miramax Books/Hyperion Books for Children,", "c", "c2002."));
        sumland.addVariableField(factory.newDataField("300", ' ', ' ', "a", "500 p. ;", "c", "22 cm."));
        sumland.addVariableField(factory.newDataField("520", ' ', ' ', "a",
                "Ethan Feld, the worst baseball player in the history of the game, finds himself recruited by a 100-year-old scout to help a band of fairies triumph over an ancient enemy."));
